...
class SendCoinController extends Controller
{
    ...
    private function _form_validation($request)
    {
        ...
        $postData = array(
            ...
            'coins'         => $request->coins,
            'type'          => 'C',
            'status'        =>  "<b>".config('app.company_name') . "</b> sent you " . $request->coins . " ".Functions::purchase_product_name()
        );
    ...
    public function store(Request $request)
    {
        ...
        $not_data['message'] = config('app.company_name') . " sent you ". $request->coins ." ".Functions::purchase_product_name();
        $not_data['type'] = "G";
        $not_data['video_id'] = 0;
        ...
        As a token of our appreciation for joining us, we're giving you ".$request->coins." ".Functions::purchase_product_name()." to use in the app. 
        These ".Functions::purchase_product_name()." can be used to send gifts to your friends and loved ones within the app. 
        ...
        <br />
        Use your ".$request->coins." ".Functions::purchase_product_name()." to send gifts to friends and family.<br />
        They receive your thoughtful gifts and can redeem them for real money.<br />
        <br />
        Claim your ".$request->coins." ".Functions::purchase_product_name()." now.<br />
        ...
        $array = array('subject' => "Welcome to " . config('app.company_name') . "! Here's ".$request->coins." ".Functions::purchase_product_name()." to get you started 🎁", 'view' => 'emails.site.company_panel', 'body' => $mailBody);
        ...
        try {
            if ($user->fcm_token && $user->fcm_token != "" && $user->fcm_token != null) {
                $title = $request->coins." ".Functions::purchase_product_name()." RECEIVED";
                $message = config('app.company_name') . " sent you ".$request->coins." ".Functions::purchase_product_name();
        ...
        return redirect(config('app.admin_url') . '/send-coins')->with('success', Functions::purchase_product_name().' sent successfully');
    }
