...
<section class="h4-about s-padding ">
    <div class="container">
        ...
        <div class="row" id="leukeVideos" style="padding-bottom: 10%;">
            @php
            $count=0;
            @endphp
            <?php $x = 1; ?>
            ...
            <div class="col-lg-3 col-md-6 col-12 video p-2" style="text-align:center;">
                <div style="box-shadow: 0px 2px 8px #ccc;border-radius: 5px;padding:10px;">
                    ...
                    <div class="video-container">
                        <video muted="muted" id="video_{{$count}}" data-toggle="modal" data-target="#LeukeModal" onmouseover="hoverVideo('{{$count}}')" onmouseout="hideVideo('{{$count}}')" class="" style="width:100%;height:100%;background: #000;border-radius: 8px;" loop preload="none" onclick="modelbox_open('{{ asset(Storage::url('public/videos/' . $video->user_id . '/' . $video->video )) }}', {{ $video->video_id }})" poster="{{ asset(Storage::url('public/videos/' . $video->user_id . '/thumb/' . $video->thumb )) }}">
